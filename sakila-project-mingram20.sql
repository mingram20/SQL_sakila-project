-- Initiate which Database to use
USE sakila;
...
-- 7f. Write a query to display how much business, in dollars, each store brought in.
	-- Query is summing the AMOUNT column from the payment table
